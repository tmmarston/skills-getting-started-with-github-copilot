document.addEventListener("DOMContentLoaded", () => {
                  ...
                  .map(
                    (participant) =>
                      `<li>
                        ...
                        <button class="remove-participant-button" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}">×</button>
                      </li>`
                  )
                  .join("")}
              </ul>
  ...
  // Allow removing participants with the delete icon
